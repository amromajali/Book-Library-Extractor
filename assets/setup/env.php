...
if (!defined('APP_NAME'))                       define('APP_NAME', 'Books System');
if (!defined('APP_ORGANIZATION'))               define('APP_ORGANIZATION', 'JU');
if (!defined('APP_OWNER'))                      define('APP_OWNER', 'Amro');
if (!defined('APP_DESCRIPTION'))                define('APP_DESCRIPTION', 'Books System');
